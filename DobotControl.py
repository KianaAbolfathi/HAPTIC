        ...
        if lock == 0:
            ...
            #The following can be commented out to avoid movement in Y and Z direction. 
               ...
               cmd = 8
                ...
                cmd = 0 
        #Making a scaled down version of the value x for Kiana's experiment
        kiana_valuex = valuex/10
        kiana_valuey = valuey/10
        kiana_valuez = valuez/10
        #map the valocity of the arm according to the radius of the haptic devices input
        vel = math.sqrt(pow(kiana_valuex,2)+pow(kiana_valuey,2)+pow(kiana_valuez,2))
